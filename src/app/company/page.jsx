...
const page = () => {
   return (
       <div>
         <section className="flex justify-evenly mx-12 my-12">
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
               ...
               <div>
                  <span class="block text-2xl font-bold">81</span>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
               ...
               <div>
                  <span class="block text-2xl font-bold">126</span>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
               ...
               <div>
                  <span class="inline-block text-2xl font-bold">69</span>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
               <div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-blue-600 bg-blue-100 rounded-full mr-6">
                  <MdOutlineFileDownloadDone className="text-3xl"/>
                  {/* <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
