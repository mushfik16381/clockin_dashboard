                ...
                <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 ">
                  ...
                  <div>
                    <div class="inline-flex gap-x-2">
                      ...
                      <Link class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm " href="/company/worker/addWorker">
                      ...
                      <td class="h-px w-24 whitespace-nowrap">
                        <div className="flex justify-evenly ">
                          <div class="hs-tooltip inline-block">
                            <Link href='/company/worker/viewWorker'>
                          ...
                          <div class="hs-tooltip inline-block">
                            <Link href='/company/worker/editWorker'>
                            <button type="button" class="hs-tooltip-toggle text-2xl">
                ...
                <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 ">
                  <div>
                    <p class="text-sm text-gray-600 ">
                      <span class="font-semibold text-gray-800 ">{worker?.length}</span> results
                    </p>
                  </div>
