    ...
    >
      ...
      <ul className='hs-accordion-group'>
        ...
        <li class="hs-accordion " id="account-accordion">
          <Link class="hs-accordion-toggle flex items-center gap-x-2 pt-4 px-2 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-lg text-white rounded-md  hover:text-white" href="javascript:;">
            <FaBuildingUser />
            Company
